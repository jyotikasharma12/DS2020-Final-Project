...
The research questions focus on comparisons involving bill length, bill
depth, flipper length, body mass, species, sex, and island because these
variables enable the most meanigful investigation of biological
differences and ecological patterns within the Palmer Penguins dataset.
These variable comparisons reflect shared functional roles. Bill length
and depth capture variation in feeding-related anatomy that is known to
differ across penguin species, while flipper length and body mass serve
as reliable indicators of overall body size and locomotion efficiency.
